	...
	(function() {
		...
		select.each(function() {
			  $(this).children().each(function() {
				$(this).parent().siblings('.js-custom-select').append('<div class="custom-select__option">' + $(this).text() + '</div>');
			});
			...
			currentOption.on('click', function() {
					if ($(this).parent().hasClass('is-active')) {
						...
						$(this).parent().addClass('is-priority');
						$(this).parent().addClass('is-active');
						customSelect.slideDown(function(){
							$(this).parent().removeClass('is-priority');
						});
					}
